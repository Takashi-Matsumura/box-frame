...
export const tools = [
    {
        ...
        description: "OpenLDAPサーバの接続状態を確認します。サーバーが利用可能かどうかと接続情報を返します。",
        inputSchema: {
            type: "object",
            properties: {},
            required: [],
    ...
    },
    {
        ...
        description: "OpenLDAPに登録されているユーザーの一覧を取得します。ページネーションに対応しています。",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
    ...
    },
    {
        ...
        description: "ユーザーを検索します。uid、cn（名前）、mail（メール）、displayName（表示名）、employeeNumber（社員番号）で部分一致検索できます。",
        inputSchema: {
            type: "object",
            properties: {
                query: {
